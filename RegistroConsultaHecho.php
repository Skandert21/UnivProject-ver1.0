...
*/
if ($Total == 0) {
	header("Location: RegistroConsultaDos.php?status=2");
} else {
...
$descripcion = "El usuario ".$_SESSION["username"]." añadió la consulta del cliente ".$ncr." portador de la cédula ".$idd." y su mascota ".$npr." en el área de mascotas *perruquería* satisfactoriamente. Los servicios aplicados a la mascota son los siguientes: ";
