...
unset($_SESSION['carritoV']);
	...
	$sql='SELECT *FROM cliente_venta where c_check = 0 ORDER BY id_c DESC';
...
<body style="background-color: #e9e9e9" >
		...
		<div class="jaula">
			<div class=""><td class="formularioesp"><a class="btn_a" href="RegistroClienteVenta.php">Nuevo</a></td></div>
	    </div>
...
--><div class="container" style="margin-bottom: 100px; padding: 20px; background-color: #fff; text-shadow: 0 0 30px #fff;
		...
		<table class="table table-bordered" id="tabla_cliente">
			...
			<tr class="head">
				...
				<th class="formularioesp2">Vender</th>
			...
			<?php foreach($resultado as $fila):?>
				<tr id="" >
					<td class="formularioesp"><?php echo $fila['id_c']; ?></td>
					<td class="formularioesp"><?php echo $fila['nombre_c']; ?></td>
					<td class="formularioesp"><?php echo $fila['apellido_c']; ?></td>
					<td class="formularioesp"><?php echo $fila['telefono_c']; ?></td>
					

					<td class="formularioesp"><a href="UpdateClienteVenta.php?id_c=<?php echo $fila['id_c']; ?>"  class="success" >Editar</a></td>
					<form method="POST" action="DeleteClienteVenta.php">
					
					<td class="formularioesp" id=""><button class="delete" type="submit" id="borrado" name="borrado" onclick="return borrar()" value="<?php echo $fila['id_c']; ?>">Eliminar</button></td>
					</form>

					<td class="formularioesp"><a href="NuevaVenta.php?id_c=<?php echo $fila['id_c']; ?>"  class="info" >Vender</a></td>
