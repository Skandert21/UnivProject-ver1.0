...
*/
if ($Total == 0) {
	header("Location: GestionarCompra.php?status=2");
} else {
...
$c = new SelectDatos();
$conectar = $c->Buscador();
$consulta_update=$conectar->prepare("UPDATE compra_alproveedor SET total=:total WHERE id=:id;"
				);
...
*/
	$descripcion_dos = "El usuario ".$_SESSION["username"]." actualizó la información de compra del proveedor de ".$nombre_p." ".$apellido_p.", cédula ".$id_pro.". La compra consiste en: ";
