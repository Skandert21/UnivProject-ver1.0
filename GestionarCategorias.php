...
$c= new SelectDatos();
	...
	$sentencia_select=$conectar->prepare('SELECT *FROM categoria');
	$sentencia_select->execute();
	$resultado=$sentencia_select->fetchAll();
	if (!$resultado) {?>
		<div class="alert alert-warning">
							<strong>Al parecer no has registrado ninguna categoria</strong>
						</div >
	<?php } 
	...
	if ($_GET['status']==="3") {?>
		<br>
						<div class="alert alert-warning">
							...
							<strong>¡Para borrar una categoria debes borrar primero los productos con esta categoria!</strong>
						</div>
<?php	}
}
 ...
 ?>
		...
		<div class="jaula">
			<a class="btn_a" href="./RegistroCategoria.php">Nueva Categoria</a>
		...
		<table class="table table-bordered" id="tabla_cat">
			...
			<tbody>
				...
				<tr>
					<td class="formularioesp"><?php echo $fila['id_cat']; ?></td>
					...
					<td class="formularioesp"><button onclick="return borrar()" name="borrado" id="borrado" value="<?php echo $fila['id_cat']; ?>" class="delete">Eliminar</button></td>
</form>
