...
INSERT INTO `preguntas_seguridad` VALUES (10,1,'color menos favorito','amarillo','comida favorita','pan','frecuencia de la','440'),(13,3,'color fav','rojo','lugar fav','maracay','comida fav','pan'),(14,5,'hola','hola','hola','hola','hola','hola'),(15,4,'hola','hola','hola','hola','hola','hola'),(16,6,'hola','hola','hola','hola','hola','hola');
...
INSERT INTO `producto_proveedor` VALUES (4,107013404,1),(5,98987898,3),(6,98987898,4),(7,98987898,5),(8,107013404,2);
...
INSERT INTO `productos` VALUES (1,'022','comida en lata',20,71,1,0),(2,'002','galletas para perros',10,50,1,0),(3,'009','Comedero de mascota',15,70,1,0),(4,'031','Comida para gato',10,8,1,0),(5,'556OPT','Shampoo para perros',10,0,2,1);
...
INSERT INTO `productos_vendidos` VALUES (1,1,1,8,160),(2,2,1,1,10),(3,2,2,5,50),(4,2,3,5,50),(5,1,4,10,200),(6,1,5,10,200),(7,1,6,5,100),(8,1,7,1,20),(9,3,8,1,15),(10,3,9,2,30),(14,3,1,1,15);
...
INSERT INTO `stock` VALUES (1,15,100),(2,5,50),(3,5,15),(4,10,15),(5,5,20);
...
INSERT INTO `user` VALUES (1,'admin1','$2y$10$kDToaZEeS47GDy5Mmad9murMeEzP4nRDoqmOFzo.zqfaCvilxLDoe',0,0),(3,'usu1','$2y$10$qP3txQtpWznOL3GlxRYgIeTJWL3zDNfBWQhaacmp1ofqj6WFnraGi',1,0),(4,'alan','12345',1,0),(5,'Jesus','1234',1,0),(6,'pedro','1234',1,0),(7,'fabian','$2y$10$e3oJpxZ6BdaLP1jyPywj/ODxsBCPH0v.Gsf68HZPvarp2hWCnFL.6',0,2);
...
INSERT INTO `ventas` VALUES (1,'2023-10-12',185,9779898),(2,'2023-10-12',50,9779898),(3,'2023-10-12',50,9779898),(4,'2023-10-12',200,9779898),(5,'2023-10-12',200,9779898),(6,'2023-10-12',100,9779898),(7,'2023-10-12',20,18782898),(8,'2023-10-13',15,9779898),(9,'2023-10-15',30,9779898);
...
-- Dump completed on 2023-10-16 12:53:34
